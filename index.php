<html>
    ...
    <body>
    <h1>To do</h1>
    - get cookie data into form fields (the whole string)
    - confirm data shows up in contact record
    - then you can write JS to parse the cookie better so it's not the whole string going in
    - if it doesn't, then try a normal text field and hiding it with CSS
...
<style>
 ...
 #_form_30_ input[type="text"],#_form_30_ input[type="date"],#_form_30_ textarea { padding:6px; height:auto; border:#979797 1px solid; border-radius:4px; color:#000 !important; font-size:13px; -webkit-box-sizing:border-box; -moz-box-sizing:border-box; box-sizing:border-box; }
 #_form_30_ textarea { resize:none; }
 #_form_30_ ._submit { -webkit-appearance:none; cursor:pointer; font-family:arial, sans-serif; font-size:14px; text-align:center; background:#333 !important; border:0 !important; -moz-border-radius:4px !important; -webkit-border-radius:4px !important; border-radius:4px !important; color:#fff !important; padding:10px !important; }
 ...
 #_form_30_ ._form_element input[type="text"],#_form_30_ ._form_element input[type="date"],#_form_30_ ._form_element select,#_form_30_ ._form_element textarea:not(.g-recaptcha-response) { display:block; width:100%; -webkit-box-sizing:border-box; -moz-box-sizing:border-box; box-sizing:border-box; }
 ...
 #_form_30_ ._error { display:block; position:absolute; font-size:13px; z-index:10000001; }
 #_form_30_ ._error._above { padding-bottom:4px; top:-41px; right:0; }
 ...
 #_form_30_ ._error-inner { padding:8px 12px; background-color:#f37c7b; font-size:13px; font-family:arial, sans-serif; color:#fff; text-align:center; text-decoration:none; -webkit-border-radius:4px; -moz-border-radius:4px; border-radius:4px; }
...
<form method="POST" action="https://filmlist.activehosted.com/proc.php" id="_form_30_" class="_form _form_30 _inline-form  _dark" novalidate>
  ...
  <div class="_form-content">
    <div class="_form_element _x50828484 _full_width _clear" >
      <div class="_form-title">
        Subscribe for Email Updates
      </div>
    </div>
    <div class="_form_element _x08640537 _full_width _clear" >
    ...
    <div class="_form_element _x65253757 _full_width " >
    ...
    <div class="_form_element _x66417087 _full_width " >
      <label class="_form-label">
        Email*
      </label>
      <div class="_field-wrapper">
...
window.cfields = {"30":"subscribeutmmedium","31":"subscribeutmsource","32":"subscribeutmcampaign"};
...
(function() {
  ...
  var form_submit = function(e) {
    ...
    if (validate_form()) {
      ...
      _load_script('https://filmlist.activehosted.com/proc.php?' + serialized + '&jsonp=true');
    }
    return false;
  };
